        ...
        function render(){
            ...
            if(tetha > delta){
                ...
                if(head.mesh.position.distanceTo(sphere1.position) < 1){
                    head.mesh.position.x = 2;
                    head.mesh.position.y = 2;
                    head.mesh.position.z = 2;
                    console.log("yes");
                ...
                else if(head.mesh.position.distanceTo(sphere2.position) < 1){
                    head.mesh.position.x = 0.5;
                    head.mesh.position.y = 0.5;
                    head.mesh.position.z = 0.5;
                    console.log("no");
                    console.log(snake.length);
                   if(snake.length>2)
                    {
